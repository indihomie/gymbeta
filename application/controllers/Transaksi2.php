...
class Transaksi2 extends CI_Controller
{
	...
	function __construct()
	{
		...
		parent::__construct();
		$this->load->model('Transaksi_model2');
	}

	function index()
	{
		$data['data_transaksi2'] = $this->Transaksi_model2->ambil_data();
		$this->load->view('transaksi/transaksi_list2', $data);
	}
	...
	public function tambah()
	{
		...
		$this->load->view('transaksi/transaksi_form2', $data);
	}
